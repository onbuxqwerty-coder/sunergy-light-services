    ...
    <header style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '12px 18px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          <img src={window.__resources.logo} alt="Sunergy Light Services" style={{ height: 36, width: 'auto', display: 'block' }} />
        </div>
      ...
      <div style={{ position: 'relative' }}>
        ...
        <div style={{ marginTop: 34, paddingTop: 24, borderTop: '1px solid rgba(255,255,255,0.1)', fontSize: 13, color: 'rgba(255,255,255,0.5)', display: 'flex', flexDirection: 'column', gap: 6 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            <img src={window.__resources.logo} alt="" style={{ height: 26, filter: 'brightness(0) invert(1)', opacity: 0.85 }} />
          </div>
...
function App() {
  ...
  const heroImage = tweaks.heroVariant === 'horizontal' ? window.__resources.familyH : window.__resources.familyV;
